...
<body>
                ...
                <div class="address">
                    ...
                    <div class="address_info">
                        ...
                        <?php foreach ($address as $address1): ?>
                            <p>
                                <input type="radio" value="<?= $address1->id ?>"
                                       name="address_id" <?= $address1->status ? "checked" : "" ?>/>
                            ...
                            <tr>
                                <td class="col1">
                                    ...
                                    <a href="<?= \yii\helpers\Url::to(['goods/detail', 'id' => $good['id']])?>">
                                        ...
                                        <img src="<?= $good['logo'] ?>" alt=""/></a> <strong>

                                        <a href="<?= \yii\helpers\Url::to(['home1/detail', 'id' => $good['id']]) ?>"><?= $good['name'] ?></a></strong></td>
    ...
    width: 135px;
    height: 36px;
    background: url(/layouts/images/order_btn.jpg) 0 0 no-repeat;
