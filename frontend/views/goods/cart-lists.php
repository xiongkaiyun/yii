...
<head>
    ...
    <link rel="stylesheet" href="/layouts/style/cart.css" type="text/css">
    ...
    <script type="text/javascript" src="/layouts/js/cart1.js"></script>
    ...
    <table>
        ...
        <?php foreach ($goods as $good):?>
            <tr id="<?=$good['id']?>">
                ...
                <td class="col3">￥<span><?=$good['sale_price']?></span></td>
                <td class="col4">
                    <a href="javascript:;" class="reduce_num"></a>
                    <input type="text" name="amount" value="<?=$good['amount']?>" class="amount"/>
                    <a href="javascript:;" class="add_num"></a>
                </td>
                <td class="col5">￥<span><?=$good['amount']*$good['sale_price']?></span></td>
