...
<head>
    ...
    <link rel="stylesheet" href="/layouts/style/goods.css" type="text/css">
    <link rel="stylesheet" href="/layouts/style/common.css" type="text/css">
    ...
    <!--引入jqzoom css -->
    <link rel="stylesheet" href="/layouts/style/jqzoom.css" type="text/css">
    ...
    <script type="text/javascript" src="/layouts/js/goods.js"></script>
    <script type="text/javascript" src="/layouts/js/jqzoom-core.js"></script>
        ...
        <div class="related_view newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="/layouts/images/relate_view1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="/layouts/images/relate_view2.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="/layouts/images/relate_view3.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="/layouts/images/relate_view4.jpg" alt="" /></a></dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><a href=""><img src="/layouts/images/relate_view5.jpg" alt="" /></a></dt>
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    <li><span>商品编号： </span><?=$good->num?></li>
                    <li class="market_price"><span>定价：</span><em>￥<?=$good->market_price?></em></li>
                    <li class="shop_price"><span>本店价：</span> <strong>￥<?=$good->sale_price?></strong> <a href="">(降价通知)</a></li>
            ...
            <div class="detail_bd">
                ...
                <div class="comment detail_div mt10">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><img src="/layouts/images/user1.gif" alt="" /></a></dt>
                                <dd><a href="">乖乖</a></dd>
                            </dl>
                        </div>
                        <div class="item">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><img src="/layouts/images/user2.jpg" alt="" /></a></dt>
                                <dd><a href="">小宝贝</a></dd>
                            </dl>
                        </div>
                        <div class="item">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><img src="/layouts/images/user3.jpg" alt="" /></a></dt>
                                <dd><a href="">天使</a></dd>
                            </dl>
                        </div>
                        <div class="item">
