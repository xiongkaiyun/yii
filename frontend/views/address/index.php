		...
		<div class="content fl ml10">
			...
			<div class="address_hd">
                ...
                <dl>
					...
					<dt>
                        <span>收货人:<?=$row->name?></span> <br>

                        <span>所在地:<?=$row->province?> <?=$row->city?> <?=$row->county?></span><br>

                        <span>详细地址:<?=$row->address?></span><br>

                        <span>联系电话:<?=$row->mobile?> </span><br>
                    </dt>
                    <dd>
						<a href="<?=\yii\helpers\Url::to(['address/edit','id'=>$row->id])?>">修改</a>
						<a href="<?=\yii\helpers\Url::to(['address/del','id'=>$row->id])?>">删除</a>
						<a href="">设为默认地址</a>
					</dd>
				</dl>
                <?php endforeach;?>
