...
?>
	...
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="<?=\yii\helpers\Url::to(['user/index'])?>"><img src="/layouts/images/logo.png" alt="京西商城"></a></h2>
		</div>
	</div>
	<!-- 页面头部 end -->
	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
			<div class="login_form fl">
				<form action="" method="post">
					...
					<!--	<li class="checkcode">
						...
						<li>
							<label for="">&nbsp;</label>
							<input type="checkbox" class="chb" name="User[checked]"  /> 保存登录信息
						</li>
						<li>
							<label for="">&nbsp;&nbsp;</label>
			...
			<div class="guide fl">
				...
				<a href="<?=\yii\helpers\Url::to(['user/reg'])?>" class="reg_btn">免费注册 >></a>
			</div>
